...
<a href="{{ route('doctor.dashboard.v2') }}" class="active">
...
<div class="card-v2">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('doctor.patients.v2') }}" class="btn-v2 btn-v2-secondary btn-v2-sm">View All</a>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <a href="{{ route('doctor.patient.view.v2', $patient->id) }}" class="btn-v2 btn-v2-primary btn-v2-sm">View</a>
                            <a href="{{ route('doctor.patient.update-status.v2', $patient->id) }}" class="btn-v2 btn-v2-secondary btn-v2-sm">Update</a>
                        </div>
                    </td>
                </tr>
                @endforeach
