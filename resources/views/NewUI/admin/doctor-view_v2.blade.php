        ...
        <div class="card-v2">
            <div class="card-body" style="text-align: center; padding: 2rem;">
                ...
                <div class="d-flex gap-2 justify-content-center">
                    <a href="{{ route('admin.doctor.edit.v2', $doctor->id) }}" class="btn-v2 btn-v2-primary">Edit Profile</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="card-v2" style="margin-top: 1.5rem;">
    ...
    <div class="card-body" style="padding: 0;">
        ...
        <div class="empty-state">
            ...
            <a href="{{ route('admin.assignments.v2') }}" class="btn-v2 btn-v2-primary" style="margin-top: 1rem;">
                Assign Patients
            </a>
        </div>
        @endif
