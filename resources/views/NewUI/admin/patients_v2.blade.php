...
<div class="mb-4" style="display: flex; justify-content: space-between; align-items: center;">
    <div style="display: flex; gap: 0.5rem;">
        ...
        <a href="{{ route('admin.patients.v2', ['status' => 'Surgery']) }}" class="btn-v2 {{ request('status') === 'Surgery' ? 'btn-v2-primary' : 'btn-v2-secondary' }} btn-v2-sm">Surgery</a>
        <a href="{{ route('admin.patients.v2', ['status' => 'Discharged']) }}" class="btn-v2 {{ request('status') === 'Discharged' ? 'btn-v2-primary' : 'btn-v2-secondary' }} btn-v2-sm">Discharged</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.patient.assign.v2', $patient->id) }}" class="btn-v2 btn-v2-secondary btn-v2-sm">Assign</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
