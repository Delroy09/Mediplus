            ...
            <div class="col-lg-5 col-md-7">
                <div class="card-v2">
                    <div class="card-body" style="padding: 2.5rem;">
                        ...
                        <!-- Login Form -->
                        <form method="POST" action="{{ route('login.v2.submit') }}">
                            @csrf
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('contact.v2') }}" style="color: var(--primary); text-decoration: none; font-weight: 600;">Apply for an account →</a>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('doctor.login.v2') }}" style="color: var(--primary); text-decoration: none; font-weight: 500; display: inline-flex; align-items: center; gap: 0.5rem;">
